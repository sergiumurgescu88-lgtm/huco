...
# Dicționar de traducere (același ca înainte)
TRANSLATIONS = {
...
print("Începere preluare produse prin WooCommerce API (cu fix imagini)...")
page = 1
while True:
    ...
    for item in products_data:
        ...
        # Formatăm imaginile - APLICĂM FIXUL AICI
        formatted_images = []
        for img in images:
            src = img.get('src')
            if src:
                # Folosim weserv.nl ca proxy pentru a evita hotlink blocking
                # Adăugăm &output=jpg pentru compatibilitate mai bună
