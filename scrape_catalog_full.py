...
TRANSLATIONS = {
    ...
    "Flash drive": "Stick USB", "Memory card": "Card de Memorie", "Mouse": "Mouse",
    "Keyboard": "Tastatură", "Watch": "Ceas", "Band": "Curea", "Screen protector": "Sticlă Protectoare",
    "Fast Charging": "Încărcare Rapidă", "Portable": "Portabil", "Smart": "Inteligent",
    "Capacity": "Capacitate", "Input": "Intrare", "Output": "Ieșire", "Weight": "Greutate",
    "Dimensions": "Dimensiuni", "Material": "Material", "Color": "Culoare", "Black": "Negru",
    "White": "Alb", "Red": "Roșu", "Blue": "Albastru", "Gold": "Auriu", "Silver": "Argintiu",
    ...
    "Shockproof": "Rezistent la Șocuri", "Flame-retardant": "Ignifug", "ABS": "ABS",
    "PC": "PC", "Aluminum": "Aluminiu", "Zinc alloy": "Aliaj de Zinc", "Leather": "Piele",
...
def get_product_details(url):
    try:
        ...
        # If no gallery found, try main image
        if not images:
        ...
        description = ""
        if desc_div:
            description = str(desc_div) # Keep HTML structure
        ...
        # Combine description and specs for the final field
        ...
        return {
            ...
            "slug": url.split('/')[-2] if len(url.split('/')) > 1 else ""
        }
...
def main():
    ...
    existing_ids = {p.get('slug') for p in existing_products if p.get('slug')}
    new_products = []
    
    page = 1
    max_pages = 182 # As per user request
    ...
    print(f"Gata! Total produse noi: {len(new_products)}")
