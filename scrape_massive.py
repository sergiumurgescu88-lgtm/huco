...
# Lista completă de categorii și numărul estimat de pagini
CATEGORIES = [
    {"url": "https://hocotech.com/category/mobile-accessories/flash-disks/", "name": "Flash Disks", "pages": 54},
    {"url": "https://hocotech.com/category/power/", "name": "Power Banks", "pages": 22},
    {"url": "https://hocotech.com/category/power/wall-chargers/", "name": "Wall Chargers", "pages": 28},
    {"url": "https://hocotech.com/category/audio/", "name": "Audio", "pages": 22},
    {"url": "https://hocotech.com/category/audio/earphones/", "name": "Earphones", "pages": 16},
    {"url": "https://hocotech.com/category/home-office/", "name": "Home Office", "pages": 90}, # Presupunem că e o categorie mare sau ai vrut să zici altceva, dar am pus 90 cum ai cerut la final
    {"url": "https://hocotech.com/category/mobile-accessories/", "name": "Mobile Accessories", "pages": 90}
]

# Dicționar extins de traducere Engleză -> Română
TRANSLATIONS = {
    "Wireless": "Fără Fir", "Bluetooth": "Bluetooth", "Charger": "Încărcător", "Power Bank": "Power Bank",
    "Headphones": "Căști", "Earphones": "Căști In-Ear", "Holder": "Suport", "Stand": "Stativ",
    "Case": "Husă", "Cable": "Cablu", "Adapter": "Adaptor", "Smart": "Inteligent",
    "Fast Charging": "Încărcare Rapidă", "Portable": "Portabil", "Mini": "Mini", "Pro": "Pro",
    "Max": "Max", "Ultra": "Ultra", "Series": "Seria", "Edition": "Ediția", "Color": "Culoare",
    "Black": "Negru", "White": "Alb", "Red": "Roșu", "Blue": "Albastru", "Green": "Verde",
    "Pink": "Roz", "Gold": "Auriu", "Silver": "Argintiu", "Gray": "Gri", "Phone": "Telefon",
    "Mobile": "Mobil", "Car": "Auto", "Desk": "Birou", "Tablet": "Tabletă", "Watch": "Ceas",
    "Speaker": "Difuzor", "Microphone": "Microfon", "Camera": "Cameră", "Lens": "Obiectiv",
    "Light": "Lumină", "LED": "LED", "USB": "USB", "Type-C": "Tip-C", "Lightning": "Lightning",
    "HDMI": "HDMI", "Audio": "Audio", "Video": "Video", "Data": "Date", "Sync": "Sincronizare",
    "Charge": "Încărcare", "Battery": "Baterie", "Capacity": "Capacitate", "mAh": "mAh",
    "Watt": "Wați", "Volt": "Volți", "Ampere": "Amperi", "Input": "Intrare", "Output": "Ieșire",
    "Protection": "Protecție", "Safety": "Siguranță", "Certified": "Certificat", "Original": "Original",
    "Genuine": "Autentic", "High Quality": "Calitate Înaltă", "Premium": "Premium",
    "Best Seller": "Cel Mai Vândut", "New Arrival": "Noutate", "Sale": "Reducere",
    "Discount": "Discount", "Offer": "Ofertă", "Deal": "Ofertă Specială", "Bundle": "Pachet",
    "Set": "Set", "Kit": "Kit", "Pack": "Pachet", "Piece": "Bucată", "Pcs": "Buc", "Unit": "Unitate",
    ...
    "Distance": "Distanță", "Speed": "Viteză", "Performance": "Performanță", "Efficiency": "Eficiență",
    "Durability": "Durabilitate", "Resistance": "Rezistență", "Waterproof": "Rezistent la Apă",
    "Dustproof": "Rezistent la Praf", "Shockproof": "Rezistent la Șocuri", "Drop Proof": "Rezistent la Căderi",
    "Scratch Resistant": "Rezistent la Zgârieturi", "Anti-Fingerprint": "Anti-Amprentă", "Matte": "Mat",
    "Glossy": "Lucios", "Transparent": "Transparent", "Clear": "Clar", "Opaque": "Opac",
    "Flexible": "Flexibil", "Rigid": "Rigid", "Soft": "Moale", "Hard": "Dur", "Lightweight": "Ușor",
    "Heavy": "Greu", "Compact": "Compact", "Slim": "Subțire", "Thin": "Subțire", "Thick": "Gros",
    "Wide": "Lat", "Narrow": "Îngust", "Long": "Lung", "Short": "Scurt", "Tall": "Înalt",
    "Low": "Jos", "High": "Înalt", "Big": "Mare", "Small": "Mic", "Large": "Mare", "Tiny": "Foarte Mic",
    "Huge": "Imens", "Massive": "Masiv", "Standard": "Standard", "Custom": "Personalizat",
    "Universal": "Universal", "Specific": "Specific", "Compatible": "Compatibil", "Incompatible": "Incompatibil",
    ...
    "Foreign": "Străin", "Brand": "Brand", "Model": "Model", "Version": "Versiune", "Generation": "Generație",
    "Year": "An", "Month": "Lună", "Day": "Zi", "Week": "Săptămână", "Hour": "Oră", "Minute": "Minut",
    "Second": "Secundă", "Time": "Timp", "Date": "Dată", "Schedule": "Program", "Calendar": "Calendar",
    "Event": "Eveniment", "Meeting": "Întâlnire", "Appointment": "Programare", "Reminder": "Memento",
    "Notification": "Notificare", "Alert": "Alertă", "Warning": "Avertisment", "Error": "Eroare",
    "Success": "Succes", "Failure": "Eșec", "Problem": "Problemă", "Solution": "Soluție", "Fix": "Reparație",
    "Repair": "Reparație", "Maintenance": "Întreținere", "Service": "Serviciu", "Help": "Ajutor",
    "Guide": "Ghid", "Manual": "Manual", "Instruction": "Instrucțiune", "Tutorial": "Tutorial",
    "Lesson": "Lecție", "Course": "Curs", "Training": "Instruire", "Education": "Educație",
    "Learning": "Învățare", "Study": "Studiu", "Research": "Cercetare", "Development": "Dezvoltare",
    "Innovation": "Inovație", "Technology": "Tehnologie", "Science": "Știință", "Engineering": "Inginerie",
    "Design": "Design", "Art": "Artă", "Culture": "Cultură", "History": "Istorie", "Geography": "Geografie",
    "Politics": "Politică", "Economy": "Economie", "Business": "Afaceri", "Finance": "Finanțe",
    "Marketing": "Marketing", "Sales": "Vânzări", "Management": "Management", "Leadership": "Leadership",
    "Team": "Echipă", "Collaboration": "Colaborare", "Communication": "Comunicare", "Networking": "Networking",
    ...
    "Program": "Program", "Code": "Cod", "Script": "Script", "Algorithm": "Algoritm", "AI": "IA",
    "Machine Learning": "Învățare Automată", "Deep Learning": "Învățare Profundă", "Neural Network": "Rețea Neurală",
    "Robotics": "Robotică", "Automation": "Automatizare", "IoT": "IoT", "Smart Home": "Casă Inteligentă",
    "Wearable": "Wearable", "VR": "VR", "AR": "AR", "MR": "MR", "Metaverse": "Metavers", "Crypto": "Crypto",
    "Blockchain": "Blockchain", "NFT": "NFT", "Bitcoin": "Bitcoin", "Ethereum": "Ethereum", "Token": "Token",
    "Coin": "Monedă", "Wallet": "Portofel", "Exchange": "Schimb", "Trading": "Tranzacționare",
    "Investment": "Investiție", "Stock": "Acțiune", "Market": "Piață", "Price": "Preț", "Cost": "Cost",
    "Value": "Valoare", "Profit": "Profit", "Loss": "Pierdere", "Revenue": "Venit", "Income": "Venit",
    "Expense": "Cheltuială", "Budget": "Buget", "Tax": "Taxă", "Fee": "Taxă", "Commission": "Comision",
    "Coupon": "Cupon", "Voucher": "Voucher", "Gift": "Cadou", "Reward": "Recompensă", "Bonus": "Bonus",
    "Prize": "Premiu", "Award": "Premiu", "Contest": "Concurs", "Competition": "Competiție", "Game": "Joc",
    "Sport": "Sport", "Fitness": "Fitness", "Health": "Sănătate", "Wellness": "Bunăstare", "Beauty": "Frumusețe",
    ...
    "Inspiration": "Inspirație", "Motivation": "Motivație", "Drive": "Impuls", "Ambition": "Ambiție"
}
...
def get_product_details(url):
    try:
        ...
        description_ro = translate_text(description)
...
print("Începere scraping masiv...")
for cat in CATEGORIES:
    print(f"\n--- Procesare categorie: {cat['name']} ---")
    page = 1
    while page <= cat['pages']:
        full_url = f"{cat['url']}page/{page}/" if page > 1 else cat['url']
        try:
            resp = requests.get(full_url, timeout=10)
            if resp.status_code != 200: 
                print(f"Pagina {page} nu există sau eroare HTTP {resp.status_code}")
                break
            ...
            if not links: 
                print(f"Nicio legătură găsită pe pagina {page}")
                break
            ...
            # Salvăm progresul la fiecare 5 pagini pentru siguranță
            if page % 5 == 0:
                all_products_temp = existing_products + new_products
                with open(DATA_FILE, 'w') as f:
                    json.dump(all_products_temp, f)
                print(f"Progres salvat la pagina {page}. Total produse noi până acum: {len(new_products)}")

            page += 1
            time.sleep(2) # Pauză mai lungă pentru a evita blocarea
        except Exception as e:
...
print(f"\n✅ Gata! Total produse acum: {len(all_products)}")
